...
### START PROCESSING
	ori $31, $0, 5	## R31 - outer max   # 20
	xor $1, $1, $1	## R1 - outer cnt   # 24	
outer:
	
	##row_ind_start = 5 * r1 = 4*r1 + r1 = r1<<2 + r1 
	##row_ind_end = row_ind_start + 5
	add $2, $1, $0	## R2 = R1			# 28
	sll $2, $2, 2		## R2 = R2 * 4		# 32
	add $2, $2, $1	## R2 = R2+R1 = row_ind_start	# 36
	addi $30, $2, 5	## R30 = R2+5 = row_ind_end	# 40
	xor $20, $20, $20	## R20 = row_sum = 0	# 44
inner_row:
